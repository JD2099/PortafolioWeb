...
import project1 from '../../public/images/projects/proximamente.png'
    ...
    return (
        ...
        lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                <span className='text-cyan-800 font-medium text-xl dark:text-primary xs:text-base'>{type}</span>
                <Link href={link}
                      target='_blank'
    ...
    return(
        ...
        dark:bg-dark dark:border-light xs:p-4'>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                <span className='text-cyan-800 font-medium text-xl dark:text-primary lg:text.lg md:text-base'>{type}</span>
                <Link href={link}
                      target='_blank'
                      className='hover:underline underline-offset-2'>
    ...
    <>
        ...
        <main className='pb-2  w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
            <Layout className='pt-16'>
                <AnimatedText text='Keep Calm and Code on.'
                ...
                <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                    <div className='col-span-12 '>
                        ...
                        link="#"
                        github="https://github.com/JD2099"
